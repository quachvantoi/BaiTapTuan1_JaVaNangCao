...
public class PrintCalendar {
    ...
    public static void printFirstDay(int month, int year) {
        ...
        System.out.print(leadingTabs +"A\t");
    }
    ...
    public static void printCalendarItself(int month, int year) {
        ...
        char[] ten={'A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E','A','B','C','D','E'};
